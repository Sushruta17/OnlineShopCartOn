  ...
  bcrypt
    ...
    .then((result) => {
      ...
      return transporter.sendMail({
        ...
        text: "Hope you enjoy shopping",
        html: "<h1> THANKS FOR LOGIN INTO MY ACCOUNT.</h1>",
      });
    })
    .then((res) => {
...
exports.postReset = (req, res, next) => {
  crypto.randomBytes(32, (err, buffer) => {
    ...
    User.findOne({ email: req.body.email })
      .then((user) => {
        if (!user) {
          req.flash("error", "User does not exist in database.");
          return res.redirect("/reset");
        }
...
exports.postNewPassword = (req, res, next) => {
  ...
  const passwordToken = req.body.tokenPassword;
  let resetUser;
  User.findOne({
    ...
    .then((hashedPassword) => {
      console.log(" rp: ", resetUser.password);
